...
class ControllerExtensionModulePtlayoutbuilder extends Controller
{
    ...
    public function index() {
        ...
        $this->document->addStyle('view/stylesheet/tmarket/layoutbuilder.min.css');
        ...
        $this->document->addScript('view/javascript/tmarket/layoutbuilder.min.js');

        $data['header'] = $this->load->controller('common/header');
        $data['column_left'] = $this->load->controller('common/column_left');
        $data['footer'] = $this->load->controller('common/footer');

        $this->response->setOutput($this->load->view('tmarket/module/ptlayoutbuilder', $data));
    }
