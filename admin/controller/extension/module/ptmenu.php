...
class ControllerExtensionModulePtmenu extends Controller
{
    ...
    public function install() {
        ...
        $this->model_tmarket_ultimatemenu->createMenuTable();
    }

    public function uninstall() {
        $this->load->model('tmarket/ultimatemenu');

        $this->model_tmarket_ultimatemenu->deleteMenuData();
    }
    ...
    public function index() {
        ...
        $data['menus'] = array();
        $menuList = $this->model_tmarket_ultimatemenu->getMenuList();
        ...
        $data['menu_editor_link'] = $this->url->link('tmarket/ultimatemenu/menulist', 'user_token=' . $this->session->data['user_token'], true);
        ...
        $this->response->setOutput($this->load->view('tmarket/module/ptmenu', $data));
    }
