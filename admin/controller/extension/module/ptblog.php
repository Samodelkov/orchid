...
class ControllerExtensionModulePtblog extends Controller
{
    ...
    public function install() {
        ...
        $this->model_tmarket_blog->install();
    ...
    public function uninstall() {
        $this->load->model('tmarket/blog');
        $this->model_tmarket_blog->uninstall();
    }
    ...
    public function index() {
        ...
        $post_lists = $this->model_tmarket_blog->getAllPostList();
        ...
        $this->response->setOutput($this->load->view('tmarket/module/ptblog', $data));
    }
