...
class ControllerExtensionModulePtcontrolpanel extends Controller
{
    ...
    public function index() {
        ...
        $data['database'] = array(
            DIR_APPLICATION . '../tmarketdata/tmarket_db1.sql' => 'Layout 1',
            DIR_APPLICATION . '../tmarketdata/tmarket_db2.sql' => 'Layout 2',
            DIR_APPLICATION . '../tmarketdata/tmarket_db3.sql' => 'Layout 3',
            DIR_APPLICATION . '../tmarketdata/tmarket_db4.sql' => 'Layout 4'
        );
        ...
        $data['cancel'] = $this->url->link('tmarket/module', 'user_token=' . $this->session->data['user_token'], true);
        ...
        $this->document->addScript('view/javascript/tmarket/selection/js/bootstrap-select.min.js');
        $this->document->addStyle('view/javascript/tmarket/selection/css/bootstrap-select.min.css');

        $data['header'] = $this->load->controller('common/header');
        $data['column_left'] = $this->load->controller('common/column_left');
        $data['footer'] = $this->load->controller('common/footer');

        $this->response->setOutput($this->load->view('tmarket/module/ptcontrolpanel', $data));
    }
    ...
    public function install() {
        $this->load->model('tmarket/controlpanel');
        $this->model_tmarket_controlpanel->setupData();
        ...
        $this->model_user_user_group->addPermission($this->user->getGroupId(), 'access', 'tmarket/module');
        $this->model_user_user_group->addPermission($this->user->getGroupId(), 'modify', 'tmarket/module');
    }
    ...
    public function uninstall() {
        ...
        $this->model_user_user_group->removePermission($this->user->getGroupId(), 'access', 'tmarket/blog');
        $this->model_user_user_group->removePermission($this->user->getGroupId(), 'modify', 'tmarket/blog');

        $this->model_user_user_group->removePermission($this->user->getGroupId(), 'access', 'tmarket/blog/post');
        $this->model_user_user_group->removePermission($this->user->getGroupId(), 'modify', 'tmarket/blog/post');

        $this->model_user_user_group->removePermission($this->user->getGroupId(), 'access', 'tmarket/blog/list');
        $this->model_user_user_group->removePermission($this->user->getGroupId(), 'modify', 'tmarket/blog/list');

        $this->model_user_user_group->removePermission($this->user->getGroupId(), 'access', 'tmarket/blog/setting');
        $this->model_user_user_group->removePermission($this->user->getGroupId(), 'modify', 'tmarket/blog/setting');

        $this->model_user_user_group->removePermission($this->user->getGroupId(), 'access', 'tmarket/slider');
        $this->model_user_user_group->removePermission($this->user->getGroupId(), 'modify', 'tmarket/slider');

        $this->model_user_user_group->removePermission($this->user->getGroupId(), 'access', 'tmarket/testimonial');
        $this->model_user_user_group->removePermission($this->user->getGroupId(), 'modify', 'tmarket/testimonial');
        ...
        $this->model_user_user_group->removePermission($this->user->getGroupId(), 'access', 'tmarket/featuredcate');
        $this->model_user_user_group->removePermission($this->user->getGroupId(), 'modify', 'tmarket/featuredcate');

        $this->model_user_user_group->removePermission($this->user->getGroupId(), 'access', 'tmarket/newsletter');
        $this->model_user_user_group->removePermission($this->user->getGroupId(), 'modify', 'tmarket/newsletter');
    }
