...
class ControllerExtensionModulePtproducts extends Controller {
    ...
    public function index() {
        ...
        if (($this->request->server['REQUEST_METHOD'] == 'POST') && $this->validate()) {
            ...
            $this->response->redirect($this->url->link('tmarket/module', 'user_token=' . $this->session->data['user_token']));
        }
        ...
        $data['breadcrumbs'][] = array(
            ...
            'href' => $this->url->link('tmarket/module', 'user_token=' . $this->session->data['user_token'])
        );
        ...
        $data['cancel'] = $this->url->link('tmarket/module', 'user_token=' . $this->session->data['user_token']);
        ...
        $this->response->setOutput($this->load->view('tmarket/module/ptproducts', $data));
    }
    ...
    public function autoGetProductsByCategory() {
        ...
        $results = $this->model_tmarket_catalog->getProductsByCategory($filter_data);
