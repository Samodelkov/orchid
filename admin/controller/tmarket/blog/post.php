<?php
class ControllerTmarketBlogPost extends Controller
{
    private $error = array();

    public function index() {
        $this->load->language('tmarket/blog/post');
    ...
    public function add() {
        ...
        if (($this->request->server['REQUEST_METHOD'] == 'POST') && $this->validateForm()) {
            $this->model_tmarket_blog->addPost($this->request->post);
            ...
            $this->response->redirect($this->url->link('tmarket/blog/post', 'user_token=' . $this->session->data['user_token'] . $url, true));
        }
    ...
    public function edit() {
        ...
        if (($this->request->server['REQUEST_METHOD'] == 'POST') && $this->validateForm()) {
            $this->model_tmarket_blog->editPost($this->request->get['post_id'], $this->request->post);
    ...
    public function delete() {
        ...
        if (isset($this->request->post['selected']) && $this->validateDelete()) {
            foreach ($this->request->post['selected'] as $post_id) {
                $this->model_tmarket_blog->deletePost($post_id);
            }
    ...
    public function copy() {
        ...
        if (isset($this->request->post['selected']) && $this->validateCopy()) {
            foreach ($this->request->post['selected'] as $post_id) {
                $this->model_tmarket_blog->copyPost($post_id);
            }
    ...
    protected function getList() {
        ...
        $data['breadcrumbs'][] = array(
            ...
            'href' => $this->url->link('tmarket/blog/post', 'user_token=' . $this->session->data['user_token'] . $url, true)
        );

        $data['add'] = $this->url->link('tmarket/blog/post/add', 'user_token=' . $this->session->data['user_token'] . $url, true);
        $data['copy'] = $this->url->link('tmarket/blog/post/copy', 'user_token=' . $this->session->data['user_token'] . $url, true);
        $data['delete'] = $this->url->link('tmarket/blog/post/delete', 'user_token=' . $this->session->data['user_token'] . $url, true);
        ...
        foreach ($results as $result) {
            $data['posts'][] = array(
                ...
                'edit'          => $this->url->link('tmarket/blog/post/edit', 'user_token=' . $this->session->data['user_token'] . '&post_id=' . $result['post_id'] . $url, true)
            );
        }
        ...
        $data['sort_name'] = $this->url->link('tmarket/blog/post', 'user_token=' . $this->session->data['user_token'] . '&sort=pd.name' . $url, true);
        $data['sort_status'] = $this->url->link('tmarket/blog/post', 'user_token=' . $this->session->data['user_token'] . '&sort=p.status' . $url, true);
        $data['sort_order'] = $this->url->link('tmarket/blog/post', 'user_token=' . $this->session->data['user_token'] . '&sort=p.sort_order' . $url, true);
        ...
        $pagination->url = $this->url->link('tmarket/blog/post', 'user_token=' . $this->session->data['user_token'] . $url . '&page={page}', true);
        ...
        $this->response->setOutput($this->load->view('tmarket/blog/post/list', $data));
    }
    ...
    protected function getForm() {
        ...
        if (!isset($this->request->get['post_id'])) {
            $data['action'] = $this->url->link('tmarket/blog/post/add', 'user_token=' . $this->session->data['user_token'] . $url, true);
        } else {
            $data['action'] = $this->url->link('tmarket/blog/post/edit', 'user_token=' . $this->session->data['user_token'] . '&post_id=' . $this->request->get['post_id'] . $url, true);
        }

        $data['cancel'] = $this->url->link('tmarket/blog/post', 'user_token=' . $this->session->data['user_token'] . $url, true);

        if (isset($this->request->get['post_id']) && ($this->request->server['REQUEST_METHOD'] != 'POST')) {
            $post_info = $this->model_tmarket_blog->getPost($this->request->get['post_id']);
            $related_posts = $this->model_tmarket_blog->getRelatedPost($this->request->get['post_id']);
        }
        ...
        if (isset($this->request->post['post_description'])) {
            ...
            $data['post_description'] = $this->model_tmarket_blog->getPostDescriptions($this->request->get['post_id']);
        } else {
        ...
        if (isset($this->request->post['post_store'])) {
            ...
            $data['post_store'] = $this->model_tmarket_blog->getPostStores($this->request->get['post_id']);
        } else {
        ...
        $this->response->setOutput($this->load->view('tmarket/blog/post/form', $data));
    }

    protected function validateForm() {
        if (!$this->user->hasPermission('modify', 'tmarket/blog/post')) {
