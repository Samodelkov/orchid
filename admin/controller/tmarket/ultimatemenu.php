<?php
class ControllerTmarketUltimatemenu extends Controller
{
    private $error = array();
    ...
    public function menuList() {
        ...
        $this->load->model('tmarket/ultimatemenu');
    ...
    public function add() {
        ...
        if (($this->request->server['REQUEST_METHOD'] == 'POST') && $this->validateForm()) {
            $this->model_tmarket_ultimatemenu->addMenu($this->request->post);
            ...
            foreach ($top_position_data as $menu_item_id => $position) {
                $this->model_tmarket_ultimatemenu->editTopItemPosition($position, $menu_item_id);
            }
            ...
            if(isset($post_data['sub_item_position2'])) {
                ...
                foreach ($sub2_position_data as $sub_item_id => $position) {
                    $this->model_tmarket_ultimatemenu->editSubItemPosition($position, $sub_item_id);
                }
            }
            ...
            $this->response->redirect($this->url->link('tmarket/ultimatemenu/menuList', 'user_token=' . $this->session->data['user_token'] . $url, true));
        }
    ...
    public function edit() {
        ...
        if (($this->request->server['REQUEST_METHOD'] == 'POST') && $this->validateForm()) {
            ...
            $this->model_tmarket_ultimatemenu->editMenu($this->request->get['menu_id'], $this->request->post);
    ...
    public function delete() {
        ...
        if (isset($this->request->post['selected']) && $this->validateDelete()) {
            foreach ($this->request->post['selected'] as $menu_id) {
                $this->model_tmarket_ultimatemenu->deleteMenu($menu_id);
            }
    ...
    public function getlist() {
        ...
        $data['breadcrumbs'][] = array(
            ...
            'href' => $this->url->link('tmarket/ultimatemenu/menuList', 'user_token=' . $this->session->data['user_token'] . $url, true)
        );

        $data['add'] = $this->url->link('tmarket/ultimatemenu/add', 'user_token=' . $this->session->data['user_token'] . $url, true);
        $data['delete'] = $this->url->link('tmarket/ultimatemenu/delete', 'user_token=' . $this->session->data['user_token'] . $url, true);
        ...
        $menus_total = $this->model_tmarket_ultimatemenu->getMenuCount();

        $menus = $this->model_tmarket_ultimatemenu->getMenuList($filter_data);
        ...
        if($menus) {
            foreach ($menus as $menu) {
                $data['menu_list'][] = array(
                    ...
                    'url'           => $this->url->link('tmarket/ultimatemenu/edit', 'user_token=' . $this->session->data['user_token'] . '&menu_id=' . $menu['menu_id'] . $url, true)
                );
            }
        }
        ...
        $pagination->url = $this->url->link('tmarket/ultimatemenu/menuList', 'user_token=' . $this->session->data['user_token'] . $url . '&page={page}', true);
        ...
        $this->response->setOutput($this->load->view('tmarket/ultimatemenu/list', $data));
    }
    ...
    public function getForm() {
        ...
        if (!isset($this->request->get['menu_id'])) {
            $data['action'] = $this->url->link('tmarket/ultimatemenu/add', 'user_token=' . $this->session->data['user_token'] . $url, true);
        } else {
            $data['action'] = $this->url->link('tmarket/ultimatemenu/edit', 'user_token=' . $this->session->data['user_token'] . '&menu_id=' . $this->request->get['menu_id'] . $url, true);
        }

        if (!isset($this->request->get['menu_id'])) {
            $this->model_tmarket_ultimatemenu->deleteTopItemByMenu('0');
            $data['cancel'] = $this->url->link('tmarket/ultimatemenu/menuList', 'user_token=' . $this->session->data['user_token'] . $url, true);
        } else {
            $data['cancel'] = $this->url->link('tmarket/ultimatemenu/menuList', 'user_token=' . $this->session->data['user_token'] . $url, true);
        }

        if (isset($this->request->get['menu_id']) && ($this->request->server['REQUEST_METHOD'] != 'POST')) {
            $menu_info = $this->model_tmarket_ultimatemenu->getMenu($this->request->get['menu_id']);
        }
        ...
        if (isset($this->request->get['menu_id'])) {
            $results = $this->model_tmarket_ultimatemenu->getTopItems($this->request->get['menu_id']);

            foreach ($results as $result) {
                $sub_items_lv2 = $this->model_tmarket_ultimatemenu->getSubItems($result['menu_item_id'], 2);

                $sub_items2 = array();

                if($sub_items_lv2) {
                    foreach ($sub_items_lv2 as $item) {
                        $sub_items_lv3 = $this->model_tmarket_ultimatemenu->getSubItems($item['sub_menu_item_id'], 3);
                        ...
                        if($sub_items_lv3) {
                            foreach ($sub_items_lv3 as $s_item) {
                                $sub_items3[] = array(
                                    ...
                                    'url'           => $this->url->link('tmarket/ultimatemenu/editSubItem', 'user_token=' . $this->session->data['user_token'] . '&sub_menu_item_id=' . $s_item['sub_menu_item_id'] . '&menu_id=' . $this->request->get['menu_id'], true),
                                    'del_url'       => $this->url->link('tmarket/ultimatemenu/deleteSubItem', 'user_token=' . $this->session->data['user_token'] . '&sub_menu_item_id=' . $s_item['sub_menu_item_id'] . '&menu_id=' . $this->request->get['menu_id'], true)
                                );
                            }
                        }
                        ...
                        $sub_items2[] = array(
                            ...
                            'url'           => $this->url->link('tmarket/ultimatemenu/editSubItem', 'user_token=' . $this->session->data['user_token'] . '&sub_menu_item_id=' . $item['sub_menu_item_id'] . '&menu_id=' . $this->request->get['menu_id'], true),
                            'del_url'       => $this->url->link('tmarket/ultimatemenu/deleteSubItem', 'user_token=' . $this->session->data['user_token'] . '&sub_menu_item_id=' . $item['sub_menu_item_id'] . '&menu_id=' . $this->request->get['menu_id'], true)
                        );
                    }
                }
                ...
                $data['top_items'][] = array(
                    ...
                    'url'           => $this->url->link('tmarket/ultimatemenu/editTopItem', 'user_token=' . $this->session->data['user_token'] . '&menu_item_id=' . $result['menu_item_id'] . '&menu_id=' . $this->request->get['menu_id'], true),
                    'del_url'       => $this->url->link('tmarket/ultimatemenu/deleteTopItem', 'user_token=' . $this->session->data['user_token'] . '&menu_item_id=' . $result['menu_item_id'] . '&menu_id=' . $this->request->get['menu_id'], true)
                );
            }
        }

        if (isset($this->request->get['menu_id'])) {
            $data['top_items_form_url'] = $this->url->link('tmarket/ultimatemenu/addTopItem', 'user_token=' . $this->session->data['user_token'] . '&menu_id=' . $this->request->get['menu_id'], true);
            $data['sub_item_add_form_url'] = $this->url->link('tmarket/ultimatemenu/addSubItem', 'user_token=' . $this->session->data['user_token'] . '&menu_id=' . $this->request->get['menu_id'], true);
            $data['sub_item_edit_form_url'] = $this->url->link('tmarket/ultimatemenu/editSubItem', 'user_token=' . $this->session->data['user_token'] . '&menu_id=' . $this->request->get['menu_id'], true);
            $data['multiple_del_url'] = $this->url->link('tmarket/ultimatemenu/deleteMultipleItems', 'user_token=' . $this->session->data['user_token'] . '&menu_id=' . $this->request->get['menu_id'], true);
        } else {
            $data['top_items_form_url'] = $this->url->link('tmarket/ultimatemenu/addTopItem', 'user_token=' . $this->session->data['user_token'], true);
            $data['sub_item_add_form_url'] = $this->url->link('tmarket/ultimatemenu/addSubItem', 'user_token=' . $this->session->data['user_token'], true);
            $data['sub_item_edit_form_url'] = $this->url->link('tmarket/ultimatemenu/editSubItem', 'user_token=' . $this->session->data['user_token'], true);
            $data['multiple_del_url'] = $this->url->link('tmarket/ultimatemenu/deleteMultipleItems', 'user_token=' . $this->session->data['user_token'], true);
        }

        $data['get_top_items_url'] = $this->url->link('tmarket/ultimatemenu/getTopItemsByAjax', 'user_token=' . $this->session->data['user_token'], true);

        if (!empty($_SERVER['HTTPS']) && $_SERVER['HTTPS'] != 'off') {
            $data['loader_image'] = HTTPS_CATALOG . 'image/tmarket/ajax-loader.gif';
        } else {
            $data['loader_image'] = HTTP_CATALOG . 'image/tmarket/ajax-loader.gif';
        }

        $this->document->addScript('view/javascript/tmarket/jscolor.min.js');
        $this->document->addScript('view/javascript/tmarket/ultimatemenu.min.js');
        ...
        $this->document->addStyle('view/stylesheet/tmarket/themeadmin.css');
        $this->document->addStyle('view/stylesheet/tmarket/ultimatemenu.min.css');
        ...
        $this->response->setOutput($this->load->view('tmarket/ultimatemenu/form', $data));
    }
    ...
    public function getTopItemsByAjax() {
        ...
        $results = $this->model_tmarket_ultimatemenu->getTopItems($menu_id);
        ...
        if($results) {
            ...
            foreach ($results as $result) {
                ...
                if($sub_items_lv2) {
                    foreach ($sub_items_lv2 as $item) {
                        ...
                        $sub_items2[] = array(
                            ...
                            'name'      => $item['name'],
                            'position'  => $item['position'],
                            'url'           => $this->url->link('tmarket/ultimatemenu/editSubItem', 'user_token=' . $this->session->data['user_token'] . '&sub_menu_item_id=' . $item['sub_menu_item_id'] . '&menu_id=' . $menu_id, true),
                            'del_url'       => $this->url->link('tmarket/ultimatemenu/deleteSubItem', 'user_token=' . $this->session->data['user_token'] . '&sub_menu_item_id=' . $item['sub_menu_item_id'] . '&menu_id=' . $menu_id, true)
                        );
                    }
                }
                ...
                $json['top_items'][] = array(
                    ...
                    'name'          => $result['name'],
                    'position'      => $result['position'],
                    'url'           => $this->url->link('tmarket/ultimatemenu/editTopItem', 'user_token=' . $this->session->data['user_token'] . '&menu_item_id=' . $result['menu_item_id'] . '&menu_id=' . $menu_id, true),
                    'del_url'       => $this->url->link('tmarket/ultimatemenu/deleteTopItem', 'user_token=' . $this->session->data['user_token'] . '&menu_item_id=' . $result['menu_item_id'] . '&menu_id=' . $menu_id, true)
                );
            }
        }
    ...
    public function addTopItem() {
        ...
        if (($this->request->server['REQUEST_METHOD'] == 'POST') && $this->validateTopItemForm()) {
            ...
            $menu_top_item_id = $this->model_tmarket_ultimatemenu->addTopItem($post_data);
    ...
    public function editTopItem() {
        ...
        if (($this->request->server['REQUEST_METHOD'] == 'POST') && $this->validateTopItemForm()) {
            ...
            $this->model_tmarket_ultimatemenu->editTopItem($post_data, $this->request->get['menu_item_id']);
    ...
    public function deleteTopItem() {
        ...
        if (isset($this->request->get['menu_item_id'])) {
            $this->model_tmarket_ultimatemenu->deleteTopItem($this->request->get['menu_item_id']);
        ...
        if ($this->request->server['REQUEST_METHOD'] == 'POST') {
            ...
            if(isset($post_data['top_items'])) {
                ...
                foreach ($top_items as $top_item_id) {
                    $this->model_tmarket_ultimatemenu->deleteTopItem($top_item_id);
                }
            }
            ...
            if(isset($post_data['sub_items'])) {
                ...
                foreach ($sub_items as $sub_item_id) {
                    $this->model_tmarket_ultimatemenu->deleteSubItem($sub_item_id);
                }
            }
    ...
    public function getTopItemForm($menu_id) {
        ...
        if (isset($this->request->get['menu_item_id']) && ($this->request->server['REQUEST_METHOD'] != 'POST')) {
            $menu_item_info = $this->model_tmarket_ultimatemenu->getTopItemById($this->request->get['menu_item_id']);
        }
        ...
        $lang = $this->model_tmarket_ultimatemenu->getLanguageByCode($lang_code);
        ...
        if(isset($this->request->get['menu_item_id'])) {
            $menu_item_description = $this->model_tmarket_ultimatemenu->getTopItemDescriptionById($this->request->get['menu_item_id']);
        } else {
        ...
        $categories = $this->model_tmarket_ultimatemenu->getTopCategories();
        ...
        $data['append_categories_link'] = $this->url->link('tmarket/ultimatemenu/appendChildCategories', 'user_token=' . $this->session->data['user_token'], true);
        ...
        if(!isset($this->request->get['menu_item_id'])) {
            $data['action'] = $this->url->link('tmarket/ultimatemenu/addTopItem', 'user_token=' . $this->session->data['user_token'] . '&menu_id=' . $menu_id, true);
        } else {
            $data['action'] = $this->url->link('tmarket/ultimatemenu/editTopItem', 'user_token=' . $this->session->data['user_token'] . '&menu_item_id=' . $this->request->get['menu_item_id'] . '&menu_id=' . $menu_id, true);
        }

        if(!$json) {
            $json['html'] = $this->load->view('tmarket/ultimatemenu/top_item_form', $data);
        }
    ...
    public function addSubItem() {
        ...
        if (($this->request->server['REQUEST_METHOD'] == 'POST') && $this->validateSubItemForm()) {
            ...
            $this->model_tmarket_ultimatemenu->addSubItem($post_data);
    ...
    public function editSubItem() {
        ...
        if (($this->request->server['REQUEST_METHOD'] == 'POST') && $this->validateSubItemForm()) {
            ...
            $this->model_tmarket_ultimatemenu->editSubItem($post_data, $this->request->get['sub_item_id']);
    ...
    public function deleteSubItem() {
        ...
        if (isset($this->request->get['sub_menu_item_id'])) {
            $this->model_tmarket_ultimatemenu->deleteSubItem($this->request->get['sub_menu_item_id']);
    ...
    public function getSubItemForm($menu_id) {
        ...
        if (isset($this->request->get['sub_item_id']) && ($this->request->server['REQUEST_METHOD'] != 'POST')) {
            $sub_menu_item_info = $this->model_tmarket_ultimatemenu->getSubItemById($this->request->get['sub_item_id']);
        }
        ...
        if(isset($this->request->get['sub_item_id'])) {
            $menu_item_description = $this->model_tmarket_ultimatemenu->getSubItemDescriptionById($this->request->get['sub_item_id']);
        } else {
            $menu_item_description = array();
        }
        ...
        if(!isset($this->request->get['sub_item_id'])) {
            $data['action'] = $this->url->link('tmarket/ultimatemenu/addSubItem', 'user_token=' . $this->session->data['user_token'] . '&parent_id=' . $this->request->get['parent_id'] . '&level=' . $this->request->get['level'], true);
        } else {
            $data['action'] = $this->url->link('tmarket/ultimatemenu/editSubItem', 'user_token=' . $this->session->data['user_token'] . '&sub_item_id=' . $this->request->get['sub_item_id'], true);
        }

        if(!$json) {
            $json['html'] = $this->load->view('tmarket/ultimatemenu/sub_item_form', $data);
        }
    ...
    public function appendChildCategories() {
        ...
        $childCategories = $this->model_tmarket_ultimatemenu->getCategories($category_id);
    ...
    protected function validateTopItemForm() {
        if (!$this->user->hasPermission('modify', 'tmarket/ultimatemenu')) {
    ...
    public function autoCompleteCategory() {
        ...
        if (isset($this->request->get['filter_name'])) {
            ...
            $results = $this->model_tmarket_ultimatemenu->getAllCategories($filter_data);
    ...
    public function getLinks() {
        ...
        $links[] = array(
            'label' => 'Blog Page',
            'url'   => 'index.php?route=tmarket/blog'
        );
