<?php
// Heading
$_['heading_title']         = '<b><i><i class="b fa fa-cubes"></i>  Layout Composer</i></b>';
$_['heading_primary_title'] = '<b><i><i class="fa fa-cubes"></i>  Layout Composer</i></b>';
$_['page_title']            = " Layout Composer";
