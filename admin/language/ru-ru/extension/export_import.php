...
// Текст
$_['text_success'] = 'Вы успешно импортировали свои данные!';
$_['text_success_settings'] = 'Вы успешно обновили настройки!';
...
$_['text_log_details_3_x'] = 'Проверьте \'Система &gt; Инструмены &gt; Журнал ошибок\' более детально.';
$_['text_loading_notifications'] = 'Получение сообщений';
$_['text_retry'] = 'Повторить попытку';
$_['text_used_category_ids'] = 'В настоящее время используются идентификаторы категорий от %1 до %2.';
$_['text_used_product_ids'] = 'В настоящее время используемые идентификаторы товаров находятся в диапазоне от %1 до %2.';
$_['text_welcome'] = 'Добро пожаловать в инструмент экспорта/импорта (V%1) для OpenCart.';
...
$_['entry_version'] = 'Версия инструмента экспорта/импорта';
$_['entry_oc_version'] = 'Версия OpenCart';
...
$_['error_worksheets'] = 'Недопустимые имена рабочих листов';
...
$_['error_category_seo_keywords_header'] = 'Недопустимый заголовок в листе CategorySEOKeywords';
$_['error_products_header'] = 'Недопустимый заголовок на листе товаров';
$_['error_additional_images_header'] = 'Недопустимый заголовок в листе AdditionalImages';
$_['error_specials_header'] = 'Недопустимый заголовок в листе Акции(Specials)й';
$_['error_discounts_header'] = 'Недопустимый заголовок в таблице скидок(Discounts)';
$_['error_rewards_header'] = 'Недопустимый заголовок в таблице вознаграждений(rewards)';
$_['error_product_options_header'] = 'Недопустимый заголовок в листе ProductOptions';
$_['error_product_option_values_header'] = 'Недопустимый заголовок в листе ProductOptionValues';
$_['error_product_attributes_header'] = 'Недопустимый заголовок в таблице ProductAttributes';
$_['error_product_filters_header'] = 'Недопустимый заголовок на листе ProductFilters';
$_['error_product_seo_keywords_header'] = 'Недопустимый заголовок на листе ProductSEOKeywords';
$_['error_options_header'] = 'Недопустимый заголовок в листе параметров(options)';
$_['error_option_values_header'] = 'Недопустимый заголовок в листе OptionValues';
$_['error_attribute_groups_header'] = 'Недопустимый заголовок на листе AttributeGroups';
$_['error_attributes_header'] = 'Недопустимый заголовок в таблице атрибутов(attributes)';
$_['error_filter_groups_header'] = 'Недопустимый заголовок на листе FilterGroups';
$_['error_filters_header'] = 'Недопустимый заголовок на листе фильтров';
$_['error_customers_header'] = 'Недопустимый заголовок в листе клиентов';
$_['error_addresses_header'] = 'Недопустимый заголовок в таблице адресов';
...
$_['error_category_seo_keywords'] = 'Экспорт/импорт: Отсутствуют Категории в файле импорта или в списке категорий нет значения для Категорий CategorySEOKeywords';
...
$_['error_product_seo_keywords'] = 'Экспорт/импорт: Отсутствуют товары в файле импорта или в списке товаров нет Значений для ProductSEOKeywords';
...
$_['error_min_item_id'] = 'Начальный идентификатор должен быть больше 0';
...
$_['error_incremental'] = 'Отсутствует выбор «инкрементального»(Да или Нет) для импорта';
...
$_['error_multiple_category_id_store_id'] = "Экспорт/импорт: Повторяющийся идентификатор_категории / store_id \'%1 \ '/ \'%2 \ ', указанный на листе \' CategorySEOKeywords \ '!'";
$_['error_multiple_product_id_store_id'] = "Экспорт/импорт: дубликат product_id / store_id \'%1\ '/ \'%2\ ', указанный на листе \' ProductSEOKeywords \ '!'";
$_['error_unique_keyword'] = "Экспорт/импорт: ключевое слово \'%1\ 'использовалось более одного раза для store_id \'%2\ 'на листе \'%3\ '!'";
$_['error_php_version'] = 'Экспорт/импорт: требуется PHP версии 7.2 или выше!';

$_['tab_import'] = 'Импорт';
$_['tab_export'] = 'Экспорт';
$_['tab_settings'] = 'Настройки';
$_['tab_support'] = 'Информация';
