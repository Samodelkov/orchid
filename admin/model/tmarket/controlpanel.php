<?php
class ModelTmarketControlpanel extends Model
{
    ...
    public function setupBlogData() {
        ...
        $this->model_user_user_group->addPermission($this->user->getGroupId(), 'access', 'tmarket/blog');
        $this->model_user_user_group->addPermission($this->user->getGroupId(), 'modify', 'tmarket/blog');

        $this->model_user_user_group->addPermission($this->user->getGroupId(), 'access', 'tmarket/blog/post');
        $this->model_user_user_group->addPermission($this->user->getGroupId(), 'modify', 'tmarket/blog/post');

        $this->model_user_user_group->addPermission($this->user->getGroupId(), 'access', 'tmarket/blog/list');
        $this->model_user_user_group->addPermission($this->user->getGroupId(), 'modify', 'tmarket/blog/list');

        $this->model_user_user_group->addPermission($this->user->getGroupId(), 'access', 'tmarket/blog/setting');
        $this->model_user_user_group->addPermission($this->user->getGroupId(), 'modify', 'tmarket/blog/setting');
    }
    ...
    public function setupSliderData() {
        ...
        $this->load->model('user/user_group');
        $this->model_user_user_group->addPermission($this->user->getGroupId(), 'access', 'tmarket/slider');
        $this->model_user_user_group->addPermission($this->user->getGroupId(), 'modify', 'tmarket/slider');
    }
    ...
    public function setupTestimonialData() {
        ...
        $this->load->model('user/user_group');
        $this->model_user_user_group->addPermission($this->user->getGroupId(), 'access', 'tmarket/testimonial');
        $this->model_user_user_group->addPermission($this->user->getGroupId(), 'modify', 'tmarket/testimonial');
    }
    ...
    public function setupFeaturedCategories() {
        $this->load->model('user/user_group');
        $this->model_user_user_group->addPermission($this->user->getGroupId(), 'access', 'tmarket/featuredcate');
        $this->model_user_user_group->addPermission($this->user->getGroupId(), 'modify', 'tmarket/featuredcate');
    ...
    public function setupNewsletter() {
        ...
        $this->load->model('user/user_group');
        $this->model_user_user_group->addPermission($this->user->getGroupId(), 'access', 'tmarket/newsletter');
        $this->model_user_user_group->addPermission($this->user->getGroupId(), 'modify', 'tmarket/newsletter');
    }
