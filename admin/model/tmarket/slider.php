<?php
class ModelTmarketSlider extends Model
{
    ...
    public function editSlider($ptslider_id, $data) {
      $this->db->query("UPDATE " . DB_PREFIX . "ptslider SET name = '" . $this->db->escape($data['name']) . "', status = '" . (int) $data['status'] . "', auto = '" . (int) $data['auto'] . "', delay = '" . (int) $data['delay']
      . "', hover = '" . (int) $data['hover'] . "', nextback = '" . (int) $data['nextback'] . "', contrl = '" . (int) $data['contrl'] . "',effect = '" . $data['effect'] . "' WHERE ptslider_id = '" . (int) $ptslider_id . "'");
