<?php
class ControllerTmarketLogin extends Controller {
    private $error = array();
    ...
    public function index() {
        ...
        $this->load->language('tmarket/login');
        ...
        $data['action'] = $this->url->link('tmarket/login/login', '', true);
        ...
        return $this->load->view('tmarket/quicklogin/login', $data);
}
