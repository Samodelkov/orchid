<?php
class ControllerTmarketFilter extends Controller
{
    public function index() {
        ...
        if ($category_info) {
            $this->load->language('tmarket/filter');
            ...
            $data['action'] = str_replace('&amp;', '&', $common_url . 'index.php?route=tmarket/filter/category&path=' . $category_id . $url);
            $data['clear_action'] = str_replace('&amp;', '&', $common_url . 'index.php?route=tmarket/filter/category&path=' . $category_id);
        ...
        return $this->load->view('tmarket/filter/filter', $data);
    }
    ...
    public function layer() {
        ...
        return $this->load->view('tmarket/filter/filter_ajax', $data);
    }
        ...
        if ($category_info) {
            ...
            if($data['use_filter']) {
                ...
                $data['pt_sorts'][] = array(
                    ...
                    'href'  => $common_url . 'index.php?route=tmarket/filter/category&path=' . $category_id . '&sort=p.sort_order&order=ASC' . $url
                );

                $data['pt_sorts'][] = array(
                    'text'  => $this->language->get('text_name_asc'),
                    'value' => 'pd.name-ASC',
                    'href'  => $common_url . 'index.php?route=tmarket/filter/category&path=' . $category_id . '&sort=pd.name&order=ASC' . $url
                );

                $data['pt_sorts'][] = array(
                    'text'  => $this->language->get('text_name_desc'),
                    'value' => 'pd.name-DESC',
                    'href'  => $common_url . 'index.php?route=tmarket/filter/category&path=' . $category_id . '&sort=pd.name&order=DESC' . $url
                );

                $data['pt_sorts'][] = array(
                    'text'  => $this->language->get('text_price_asc'),
                    'value' => 'p.price-ASC',
                    'href'  => $common_url . 'index.php?route=tmarket/filter/category&path=' . $category_id . '&sort=p.price&order=ASC' . $url
                );

                $data['pt_sorts'][] = array(
                    'text'  => $this->language->get('text_price_desc'),
                    'value' => 'p.price-DESC',
                    'href'  => $common_url . 'index.php?route=tmarket/filter/category&path=' . $category_id . '&sort=p.price&order=DESC' . $url
                );
                ...
                if ($this->config->get('config_review_status')) {
                    $data['pt_sorts'][] = array(
                        ...
                        'value' => 'rating-DESC',
                        'href'  => $common_url . 'index.php?route=tmarket/filter/category&path=' . $category_id . '&sort=rating&order=DESC' . $url
                    );

                    $data['pt_sorts'][] = array(
                        'text'  => $this->language->get('text_rating_asc'),
                        'value' => 'rating-ASC',
                        'href'  => $common_url . 'index.php?route=tmarket/filter/category&path=' . $category_id . '&sort=rating&order=ASC' . $url
                    );
                }
                ...
                $data['pt_sorts'][] = array(
                    ...
                    'value' => 'p.model-ASC',
                    'href'  => $common_url . 'index.php?route=tmarket/filter/category&path=' . $category_id . '&sort=p.model&order=ASC' . $url
                );

                $data['pt_sorts'][] = array(
                    'text'  => $this->language->get('text_model_desc'),
                    'value' => 'p.model-DESC',
                    'href'  => $common_url . 'index.php?route=tmarket/filter/category&path=' . $category_id . '&sort=p.model&order=DESC' . $url
                );
                ...
                foreach($limits as $value) {
                    $data['pt_limits'][] = array(
                        'text'  => $value,
                        'value' => $value,
                        'href'  => $common_url . 'index.php?route=tmarket/filter/category&path=' . $category_id . $url . '&limit=' . $value
                    );
                }
            }
            ...
            foreach ($results as $result) {
                ...
                if($data['image_effect'] == 'hover') {
                    $this->load->model('tmarket/rotateimage');

                    $product_rotate_image = $this->model_tmarket_rotateimage->getProductRotateImage($result['product_id']);
                ...
                if($data['image_effect'] == 'swatches') {
                    ...
                    $this->load->model('tmarket/swatches');
                    ...
                    foreach ($images as $img) {
                        if ($img['product_option_value_id']) {
                            $image_option_id = $this->model_tmarket_swatches->getOptionIdByProductOptionValueId($img['product_option_value_id']);
            ...
            $pt_pagination->url = $common_url . 'index.php?route=tmarket/filter/category&path=' . $category_id . $url . '&page={page}';
            ...
            $json['result_html'] = $this->load->view('tmarket/filter/category', $data);
            ...
            $json['filter_action'] =  str_replace('&amp;', '&', $common_url . 'index.php?route=tmarket/filter/category&path=' . $category_id . $url);
            ...
            $json['price_action'] =  str_replace('&amp;', '&', $common_url . 'index.php?route=tmarket/filter/category&path=' . $category_id . $url);
