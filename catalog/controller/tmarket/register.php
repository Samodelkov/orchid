<?php
class ControllerTmarketRegister extends Controller {

    private $error = array();

    public function index() {
        $this->load->language('tmarket/register');
        ...
        $data['action'] = $this->url->link('tmarket/register', '', true);
        ...
        return $this->load->view('tmarket/quicklogin/register', $data);
    }
    ...
    public function success() {
        ...
        return $this->load->view('tmarket/quicklogin/success', $data);
    }
