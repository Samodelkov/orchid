...
class ControllerExtensionModulePtsearch extends Controller
{
    public function index() {
        $this->load->language('tmarket/module/ptsearch');
        ...
        return $this->load->view('tmarket/search/form', $data);
    }
    ...
    public function ajaxSearch() {
        ...
        if(($this->request->server['REQUEST_METHOD'] == 'POST')) {
            ...
            $json['result_html'] = $this->load->view('tmarket/search/ajaxresult', $data);
