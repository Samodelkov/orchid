...
class ControllerExtensionModulePtfeaturedcate extends Controller
{
    public function index($setting) {
        ...
        $this->load->language('tmarket/module/ptfeaturedcate');
        ...
        $_featured_categories = $this->model_tmarket_catalog->getFeaturedCategories($limit);
        ...
        if ($data['categories']) {
            return $this->load->view('tmarket/module/ptfeaturedcate', $data);
        }
    }
}
