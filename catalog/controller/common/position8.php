...
class ControllerCommonPosition8 extends Controller {
	public function index() {
		...
		$modules = $this->model_design_layout->getLayoutModules($layout_id, 'position8');
		...
		return $this->load->view('common/position8', $data);
	}
}
