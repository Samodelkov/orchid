...
class ControllerCommonPosition5 extends Controller {
	public function index() {
		...
		$modules = $this->model_design_layout->getLayoutModules($layout_id, 'position5');
		...
		return $this->load->view('common/position5', $data);
	}
}
