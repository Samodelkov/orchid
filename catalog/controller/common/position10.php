...
class ControllerCommonPosition10 extends Controller {
	public function index() {
		...
		if (isset($this->request->get['route']) && $this->request->get['route'] != "common/home") {
            ...
            if($responsive_type == "specified") {
                ...
                if ( $detect->isTablet() ) {
                    ...
                    if( $detect->isMobile()){
                        $route = 'tmarket/responsive/mobile';
                    } else {
                        $route = 'common/home';
                    }
                }
		...
		$modules = $this->model_design_layout->getLayoutModules($layout_id, 'position10');
		...
		return $this->load->view('common/position10', $data);
	}
}
