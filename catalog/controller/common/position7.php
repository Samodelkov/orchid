...
class ControllerCommonPosition7 extends Controller {
	public function index() {
		...
		$modules = $this->model_design_layout->getLayoutModules($layout_id, 'position7');
		...
		return $this->load->view('common/position7', $data);
	}
}
