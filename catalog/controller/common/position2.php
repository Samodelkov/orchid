...
class ControllerCommonPosition2 extends Controller {
	public function index() {
		...
		$modules = $this->model_design_layout->getLayoutModules($layout_id, 'position2');
		...
		return $this->load->view('common/position2', $data);
	}
}
