...
class ControllerCommonPosition4 extends Controller {
	public function index() {
		...
		$modules = $this->model_design_layout->getLayoutModules($layout_id, 'position4');
		...
		return $this->load->view('common/position4', $data);
	}
}
