...
class ControllerCommonPosition6 extends Controller {
	public function index() {
		...
		$modules = $this->model_design_layout->getLayoutModules($layout_id, 'position6');
		...
		return $this->load->view('common/position6', $data);
	}
}
