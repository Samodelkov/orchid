...
class ControllerCommonPosition3 extends Controller {
	public function index() {
		...
		$modules = $this->model_design_layout->getLayoutModules($layout_id, 'position3');
		...
		return $this->load->view('common/position3', $data);
	}
}
