...
class ControllerCommonPosition9 extends Controller {
	public function index() {
		...
		$modules = $this->model_design_layout->getLayoutModules($layout_id, 'position9');
		...
		return $this->load->view('common/position9', $data);
	}
}
