...
var ptlogin = {
    'loginAction' : function(email, password) {
        $.ajax({
            url: 'index.php?route=tmarket/login/login',
            type: 'post',
            ...
            success: function (json) {
                if(json['success'] == true) {
                    if(json['enable_redirect']) {
                        ...
                        $('.pt-account').load('index.php?route=tmarket/login/headerHtml #top-links ul.pt-account li');
    ...
    'registerAction' : function () {
        ...
        $.ajax({
            url: 'index.php?route=tmarket/register/register',
            type: 'post',
    ...
    'logoutAction' : function () {
        $.ajax({
            url: 'index.php?route=tmarket/login/logout',
            dataType: 'json',
            beforeSend: function () {
    ...
    'changeEvent' : function () {
        $('#pt-register-link').attr('href', 'javascript:void(0);')
            .attr('onclick', 'ptlogin.appendRegisterForm()');
        $('#pt-login-link').attr('href', 'javascript:void(0);')
            .attr('onclick', 'ptlogin.appendLoginForm()');
        $('#pt-logout-link').attr('href', 'javascript:void(0);')
            .attr('onclick', 'ptlogin.logoutAction()');
    }
};
