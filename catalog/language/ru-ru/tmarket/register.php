...
// Заголовок
$_['heading_title'] = 'Зарегистрировать учетную запись';

// Текст
$_['text_account'] = 'Аккаунт';
$_['text_register'] = 'Регистрация';
$_['text_account_already'] = 'Если у вас уже есть учетная запись, войдите используя<a onclick="ptlogin.appendLoginForm()" href="javascript:void(0);"> форму входа </a>.';
...
$_['error_custom_field'] = 'Это поле обязательно для заполнения!';
